        ...
        <div class="col-lg-12 col-md-12">
          ...
          <div class="header_top">
            <div class="header_top_left">
              <ul class="top_nav">
                <li><a href="http://www.explorer.is-best.net/">Home</a></li>
            ...
            <!-- <a class="logo" href="index.html">
             ...
             <!-- for text logo -->
              <a class="logo" href="index.php">
               Magazine<strong>Explorer</strong> <span>A Pro Magazine</span>
             </a> 
			</div>
          ...
          <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav custom_nav">
                <li class=""><a href="http://www.explorer.is-best.net/">Home</a></li>              
                 <li class="dropdown">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm6">
              <div class="content_top_right">
				...
				<?php $page_posts = frontpage_pull_4_posts();
						while($posts_1=mysqli_fetch_assoc($page_posts)):?>		 
                  <li>
                    <img src="<?php echo $posts_1['img_src']; ?>" alt="img">
                    <div class="title_caption">
                      <a href="single.html">
                        <?php echo $posts_1['title']; ?>
                      </a>
                    </div>
                  </li>
                <?php endwhile; ?>
            ...
            <div class="content_middle_leftbar">
              <div class="single_category wow fadeInDown">
                <h2>                  
				  ...
				  <a href="category-archive.html" class="title_text">Computers</a>
                </h2>
                <ul class="catg1_nav">
				 <?php $cate1 = news_1_2(1);
					while($post_2=mysqli_fetch_assoc($cate1)):?>
					<li>
                    <div class="catgimg_container">
                      <a href="single.html" class="catg1_img">
                        <img alt="img" src="<?php echo $post_2['img_src'];?>">
                      </a>
                    </div>
                    <h3 class="post_titile"><a href="single.html"><?php echo $post_2['title'];?></a></h3>
                  </li>
				  <?php endwhile; ?>
                </ul>      
              </div>
            ...
            <div class="content_middle_rightbar">
               <div class="single_category wow fadeInDown">
                  <h2>                  
                    <span class="bold_line"><span></span></span>
                    <span class="solid_line"></span>
                    <a href="category-archive.html" class="title_text">Hardware</a>
                  </h2>
                  <ul class="catg1_nav">
				 <?php $cate1 = news_1_2(56);
					while($post_2=mysqli_fetch_assoc($cate1)):?>
					<li>
                    <div class="catgimg_container">
                      <a href="single.html" class="catg1_img">
              ...
              <div class="content_bottom_left">
                ...
                <div class="single_category wow fadeInDown">
                  ...
                  <div class="business_category_left wow fadeInDown">
                    ...
                    <?php  $result22 = get_posts(news,category_id,1,1); ?>					
					<li>
                        <div class="catgimg2_container">
                          <a href="single.html"><img alt="img" src="<?php  echo $result22['img_src']; ?>"></a>
                        </div>
                        <h2 class="catg_titile"><a href="single.html"><?php  echo $result22['title']; ?></a></h2>
                        <div class="comments_box">
                          <span class="meta_date"><?php  echo substr($result22['datetime'],0,10) ?></span>
                          <span class="meta_comment"><a href="#">No Comments</a></span>
                          <span class="meta_more"><a  href="#">Read More...</a></span>
                        <p><?php  echo substr($result22['content'],0,160) ?></p>
						</div>
					 </li>
					</ul>
                  </div>  
                  <div class="business_category_right wow fadeInDown">
                    <ul class="small_catg">
					           <?php 
                     $news_1_3 = news_1_3(1); 
                     while ($news_1_3_=mysqli_fetch_assoc($news_1_3)){
                      ...
                      <li>
                        <div class="media wow fadeInDown">
                          <a class="media-left" href="single.html">
                            <img src="<?php echo $news_1_3_['img_src']; ?>" alt="img">
                          </a>
                          <div class="media-body">
                            <h4 class="media-heading"><a href="single.html"><?php echo $news_1_3_['title']; ?></a></h4> 
                            <div class="comments_box">
                              <span class="meta_date"><?php  echo substr($news_1_3_['datetime'],0,10) ?></span>
                              <span class="meta_comment"><a href="#">No Comments</a></span>
                            </div>
                          </div>
                        </div>
